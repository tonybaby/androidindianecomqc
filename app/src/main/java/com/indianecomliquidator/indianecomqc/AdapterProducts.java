...
//                        Log.i("location", "Inside viewHolder onEdit" + productId);
                        SharedPreferences pref = context.getSharedPreferences("SelectedProductId", MODE_PRIVATE);
                        SharedPreferences.Editor editor = pref.edit();
                        editor.putInt("selectedProductId", Integer.parseInt(productId));
                        editor.commit();
